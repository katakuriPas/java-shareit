...
public class ItemController {
    ...
    public ItemDto update(@RequestHeader("X-Sharer-User-Id") Long userId, @PathVariable Long itemId, @RequestBody ItemDto itemDto) {
        log.info("PatchMapping: update userId = {}, itemId = {}, itemDto = {}", userId, itemId, itemDto);
    ...
    @GetMapping
    public Collection<ItemDto> getAllItemByOwner(@RequestHeader("X-Sharer-User-Id") Long ownerId) {
